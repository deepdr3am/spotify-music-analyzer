              ...
              <div className="xl:col-span-2">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">你的熱門歌曲</h2>
                      <p className="text-blue-200">最常播放的音樂作品</p>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto custom-scrollbar">
                    {topTracks.map((track, index) => (
                      <div key={track.id} className="bg-white/5 hover:bg-white/10 transition-all duration-200 rounded-xl p-4 border border-white/10 hover:border-white/20 group">
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center mb-2">
                              <span className="inline-flex items-center justify-center w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full text-white text-sm font-bold mr-2">
                                {index + 1}
                              </span>
                            ...
                            <p className="text-blue-200 text-sm mb-1 truncate">{track.artists.join(', ')}</p>
                            <p className="text-blue-300 text-xs truncate mb-2">{track.album}</p>
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                ...
                                <span className="text-green-400 font-medium text-sm">{track.popularity}%</span>
                              </div>
                              <a 
                                href={track.external_url} 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="text-green-400 hover:text-green-300 text-sm font-medium flex items-center group-hover:underline"
                              >
              ...
              <div className="xl:col-span-1">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white">你的熱門藝人</h2>
                      <p className="text-blue-200">最愛的音樂創作者</p>
                    </div>
                  </div>
                  
                  <div className="space-y-4 max-h-96 overflow-y-auto custom-scrollbar">
                    {topArtists.map((artist, index) => (
                      <div key={artist.id} className="bg-white/5 hover:bg-white/10 transition-all duration-200 rounded-xl p-4 border border-white/10 hover:border-white/20 group">
                        <div className="flex items-start justify-between">
                          <div className="flex items-start flex-1 min-w-0">
                            <div className="w-10 h-10 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold mr-3 flex-shrink-0">
                              {index + 1}
                            </div>
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex flex-wrap gap-1 mb-2">
                                {artist.genres.slice(0, 2).map((genre, i) => (
                                  <span key={i} className="inline-block bg-purple-500/20 text-purple-200 text-xs px-2 py-1 rounded-lg capitalize">
                                    {genre}
                                  </span>
                                ))}
                                {artist.genres.length > 2 && (
                                  <span className="inline-block bg-gray-500/20 text-gray-300 text-xs px-2 py-1 rounded-lg">
                                    +{artist.genres.length - 2}
                                  </span>
                                )}
                              </div>
                              <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                  ...
                                  <span className="text-green-400 font-medium text-sm">{artist.popularity}%</span>
                                </div>
                                <a 
